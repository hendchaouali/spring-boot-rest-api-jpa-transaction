package com.rest.transaction.web.exception;
 ...
 * "message": "Validation failed for argument [0] in public org.springframework.http.ResponseEntity<com.rest.artist.model.Song> ...",
 * "description": "uri=/api/tickets",
 * "fieldErrors": [
 * {
 * "objectName": "ticket",
 * "field": "code",
 * "message": "NotBlank: code ne doit pas être null ou vide"
 * }
 * ]
 * }
 */
